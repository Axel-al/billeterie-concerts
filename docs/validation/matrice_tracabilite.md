...
| RG8 | Pages panier/checkout personnelles, pages resultat, historique paye et detail de commande filtres par utilisateur | `tests/test_booking_flow.py::test_user_cannot_access_another_users_cart_checkout_or_order_pages`, `tests/test_order_history.py::test_user_sees_only_their_own_paid_orders`, `test_user_cannot_access_another_users_paid_order_detail`, `test_anonymous_order_history_and_detail_access_redirect_to_login` | Couvert | Historique limite aux commandes payees |
