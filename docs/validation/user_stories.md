...
| US2 | Visiteur | En tant que visiteur, je veux consulter le détail d'un concert afin de connaitre date, lieu, prix et disponibilités. | EF2 |
...
| US8 | Administrateur | En tant qu'administrateur, je veux gérer les concerts et consulter les ventes afin de controler la billetterie. | EF11, EM9, RG7 |
