...
Motif : le prompt demande explicitement de compléter la structure documentaire sans initialiser Django sauf s'il est déjà présent. Le dépôt ne contient actuellement aucun projet Django.
